...
aliases: ["realms-of-knowing", "realms of knowing"]
glyph-prefix: "⧈"
glyph-family: containment
dimensions: [speculative, poetic]
domains: [learning-design, relational-ethics]
version: v5
status: standard
word-class: noun, plural
phonetic: "/rɛlmz əv ˈnoʊ.ɪŋ/"
tags:
  - glyph/containment
...
From Old French *reaume* "kingdom, domain" + Old English *cnāwan* "to know".
...
- [[threshold]] — realms are thresholds of knowing
...
| Recursive | Non-Linear | Symbolic | Navigational | Risk-Bearing |
|-----------|------------|----------|--------------|--------------|
| ☑ Yes | ☑ Yes | ☑ Yes | ☑ Yes | ☑ Yes |
