---
title: "ontological violence"
aliases: ["ontological-violence", "ontological violence"]
glyph-prefix: "⟁"
glyph-family: integrity
dimensions: [poetic]
domains: [agent-safety, learning-design, relational-ethics, governance]
version: v5
status: standard
word-class: noun
...
From Greek *ontos* (ὄντος) "being" + *logos* (λόγος) "reason, discourse" → ontology = the study of being. Latin *violentia* "force, vehemence, injustice".
...
| Charge | Recursive | Harmful | Systemic |
|--------|-----------|---------|----------|
