...
aliases: ["cognitive-capture", "cognitive capture"]
glyph-prefix: "⧈"
glyph-family: containment
dimensions: [mechanic]
domains: [agent-safety, learning-design, relational-ethics]
version: v5
status: standard
word-class: noun
...
- **Sovereignty loss**
- **Systemic override**
- [[cognitive-sovereignty]] — the inverse condition
- [[mindgate]] — the structural antidote

## ⟡ Attributes

| Charge | Recursive | Subtle | Contagious | Reversible |
|--------|-----------|--------|------------|------------|
