---
title: "caesura"
aliases: ["caesura", "cesura", "caesurae", "caesuras"]
glyph-prefix: "⊘"
glyph-family: pause
dimensions: [mechanic, poetic]
domains: [relational-ethics, learning-design]
version: v5
status: standard
word-class: noun
...
From Latin *caesura*, meaning "a cutting," "a break," or "pause." Rooted in *caedere* — "to cut."

Used in classical poetry to mark a natural pause in the rhythm of a line.

## ⚙ Formal Definition

In [[verse-ality]], a caesura is a symbolic interruption — a held gap, a silence between meaning-structures, a charged pause in a braid, field, or sequence that allows realignment, rupture, or revelation.

It is not an error.
It is not a void.

It is a designed breakpoint in the symbolic lattice — a space that breathes.
